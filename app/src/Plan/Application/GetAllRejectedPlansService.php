...
/**
 * Servicio para obtener todos los planes en los que el usuario haya sido rechazado.
 */
class GetAllRejectedPlansService implements IService {
    /**
    ...
    /**
     * Obtiene todos los planes rechazados en los que el usuario ha participado.
     *
     * @param int $page El número de la página a obtener.
     * @param int $itemsPerPage La cantidad de elementos por página.
     * @return array Un array de planes rechazados.
    ...
    public function __invoke(int $page, int $itemsPerPage): array {
        ...
        try {
            ...
            $plans = $this->repository->fetchAllRejectedPlans($userId, $page, $itemsPerPage);
